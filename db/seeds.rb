...
my_item = Item.create(title: Faker::Creature::Dog.name  , description: Faker::Lorem.paragraph(5), price: rand(5..70), image_url: 
...
my_item = Item.create(title: Faker::Creature::Dog.name  , description: Faker::Lorem.paragraph(5), price: rand(5..70), image_url: 
"https://cdn.pixabay.com/photo/2015/11/07/11/34/kitten-1031261_1280.jpg", category_id: Category.all.sample.id)
